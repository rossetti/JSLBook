...
![(\#fig:WelchSysTimePlot)Welch Plot for System Time Analysis](./figures/ch7/WelchSysTimes.png) 
...
\begin{figure}
\includegraphics[width=0.8\linewidth,height=0.8\textheight]{./figures/ch7/ch7fig72} \caption{Indifference Zone Concept}(\#fig:IndifZone)
\end{figure}
